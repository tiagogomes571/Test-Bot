...
let blacklisted = ['!report', 'discord.gg', '!ping', '!prefixo', '!ban', '!kick', '!avisar', '!mute', '!ajuda', '!limpar', '!avisos', '!staff', '!saldo', '!nivel', '!transferir', '!botinfo', '/report', '/ping', '/prefixo', '/ban', '/kick', '/avisar', '/mute', '/ajuda', '/limpar', '/avisos', '/staff', '/saldo', '/transferir', '/nivel', '/botinfo'];
